export class View {
    ...
    initializeParameters(params) {
        this.elements.topK.max = 128;
        this.elements.topK.min = 1;
        this.elements.topK.value = 3;
        this.elements.topKValue.textContent = 3;

        this.elements.temperatureValue.textContent = 1;
        this.elements.temperature.max = 2;
        this.elements.temperature.min = 0;
        this.elements.temperature.value = 1;
    }
